...
class AndroidCacheDataSourceFactory implements DataSource.Factory {
    ...
    AndroidCacheDataSourceFactory(Context context, long maxCacheSize, long maxFileSize, String id) {
        super();
        this.context = context;
        this.maxCacheSize = maxCacheSize;
        this.maxFileSize = maxFileSize;
        AndroidCacheDataSourceFactory.id = id;
    ...
    public SimpleCache getInstance(Context context) {
        ...
        if (simpleCache == null) simpleCache = new SimpleCache(new File(context.getFilesDir(), "SWANN"), evictor, new ExoDatabaseProvider(context));
        return simpleCache;
    }
